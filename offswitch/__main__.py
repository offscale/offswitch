...
def _build_parser():
    ...
    parser.add_argument('-s', '--strategy', help='strategy file [providers.sample.json]',
    ...
    parser.add_argument('-p', '--provider', help='Only switch off this provider. Can be specified repetitively.',
                        action='append')
    parser.add_argument('-d', '--delete', help='Only switch off this name. Can be specified repetitively.',
                        action='append')
